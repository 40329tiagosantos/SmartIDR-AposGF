...
public class PedirAutenticacaoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        actionPage.setText("Lock");
        actionPage.setImageResource(R.drawable.iconautenticacao);
        ...
        actionPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(DetetorLigacaoSmartphone.estado.equals("SemLigacao")){
                    ...
                    String mensagem = "PedirAutenticacao";
        ...
        actionPage.setColor(Color.parseColor("#59D1AB"));
