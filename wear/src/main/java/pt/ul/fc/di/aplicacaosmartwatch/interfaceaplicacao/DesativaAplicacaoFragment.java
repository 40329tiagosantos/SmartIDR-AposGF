...
public class DesativaAplicacaoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        actionPage.setText("Home");
        actionPage.setImageResource(R.drawable.icondesativaraplicacao);
        ...
        actionPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(DetetorLigacaoSmartphone.estado.equals("SemLigacao")){
                    ...
                    String mensagem = "DesativarAplicacao";
        ...
        actionPage.setColor(Color.parseColor("#7f7f7f"));
